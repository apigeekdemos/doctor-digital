...
if (!isBasePath) {
    var availableResources = ["AllergyIntolerance","Appointment", "CarePlan", "Condition", "Coverage", "DiagnosticOrder", "DiagnosticReport", "DocumentReference", "Encounter", "Immunization", "Location", "MedicationAdministration", "MedicationDispense", "MedicationOrder", "MedicationStatement", "Observation", "Patient", "Practitioner", "Procedure", "Schedule"];
